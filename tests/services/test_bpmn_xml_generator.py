...
class TestBpmnXmlGenerator:
    ...
    def test_create_bpmn_xml_parallel(self, procurement_process_fixture):
        ...
        result = xml_generator.create_bpmn_xml(procurement_process_fixture)
    ...
    def test_create_bpmn_xml_linear(self, linear_process_fixture):

        xml_generator = BpmnXmlGenerator()

        result = xml_generator.create_bpmn_xml(linear_process_fixture)
    ...
    def test_create_bpmn_exclusive(self, order_process_fixture):
